...
import { validateEmail, checkRateLimit, clearRateLimit, formatAuthError } from '@/lib/auth-helpers'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!rateCheck.allowed) {
        ...
        throw new Error(`Too many login attempts. Please wait ${waitMinutes} minutes before trying again.`)
      }
      ...
      if (error) {
        ...
        console.log('Signin successful, clearing rate limit and redirecting...')
